...
pub type CostingTabPage = Page<CostingTabContent>;

pub struct CostingTabContent {
    tab: RefCell<Tab>,
    props: Props,
...
impl Component for CostingTabContent {
    type Message = ();
    ...
    fn create(props: Self::Properties, link: ComponentLink<Self>) -> Self {
        ...
        CostingTabContent { tab, props, link }
    }
            ...
            <nav class="level">
                <div class="level-left">
                    <div class="level-item">
                        <h3 class="title is-3">{ "Costing Tab Page" }</h3>
                    </div>
                </div>
