...
pub type CostingTabListPage = Page<CostingTabListContent>;

pub struct CostingTabListContent {
    tab: RefCell<Tab>,
    props: Props,
...
impl Component for CostingTabListContent {
    type Message = ();
    ...
    fn create(props: Self::Properties, link: ComponentLink<Self>) -> Self {
        ...
        CostingTabListContent { tab, props, link }
    }
